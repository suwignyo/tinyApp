...
app.get("/urls", (req, res) => {
  let templateVars = { urls: urlsForUser(req.cookies.username),
...
app.post("/urls", (req, res) => {
  ...
  if (errors.length > 0){
    ...
    urlDatabase[newShort] = {"long_URL": req.body.longURL, "owner" : req.cookies.username}
    res.redirect('/urls');
    }
})
